...
@WebServlet("/AddnikonproductCtrl")
public class AddnikonproductCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cnt = dao.addnikonproduct(vo);
		
		if(cnt!=0) {
			response.sendRedirect("GetnikonproductListCtrl");
		} else {
			response.sendRedirect("/product/addnikonproduct.jsp");
		} 
	}
}
